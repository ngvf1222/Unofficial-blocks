const LibraryCreator = {
  start: (blocksJSON, category, text) => {
    ...
    if (typeof useWebGL == "undefined") {
      ...
      // 아이콘 적용
      $('head').append(`<style>#entryCategory${category}{background-image:url(https://i.imgur.com/TKMUUa9.png#.YTGMAF42ZBM.link);background-color:#007bff;border-color:#006ce0;color:#fff}</style>`)
      // 카테고리 이름 적용
      $(`#entryCategory${category}`).append(text)
    }
    console.log('%cMath블럭 v0.1%c\n\nMath블럭는 MIT License를 따릅니다.', 'background-color: #007bff; color: #e9ecef; padding: 0 3rem; border-radius: 1.2rem 0; font-family: sans-serif; font-size: 2.5rem;', 'font-family: sans-serif; font-size: 1.2rem;', 'font-family: sans-serif; font-size: 1.2rem;', 'font-family: sans-serif; font-size: 1.1rem; color: #007bff;')
  }
}
let blockPOST
const blocks = [
  ...
  },
  {
    ...
    r = Math.exp(script.getValue('A', script))
    return r
    },
  },
  {
  ...
  },
  {
    ...
    class: 'text',
    func: async (sprite, script) => { // 코드
    r = Math.sign(script.getValue('A', script))
    return r
    },
  },
  {
  ...
  },
  {
    ...
    class: 'text',
    func: async (sprite, script) => { // 코드
    r = Math.sinh(script.getValue('A', script))
    return r
    },
  },
  {
    ...
    class: 'text',
    func: async (sprite, script) => { // 코드
    r = Math.cosh(script.getValue('A', script))
    return r
    },
  },
  {
    ...
    class: 'text',
    func: async (sprite, script) => { // 코드
    r = Math.tanh(script.getValue('A', script))
    return r
    },
  },
  {
    ...
    class: 'text',
    func: async (sprite, script) => { // 코드
    r = Math.asinh(script.getValue('A', script))
    return r
    },
  },
  {
    ...
    class: 'text',
    func: async (sprite, script) => { // 코드
    r = Math.acosh(script.getValue('A', script))
    return r
    },
  },
  {
    ...
    class: 'text',
    func: async (sprite, script) => { // 코드
    r = Math.atanh(script.getValue('A', script))
    return r
    },
  }
]

LibraryCreator.start(blocks, 'API', 'Math블럭!')